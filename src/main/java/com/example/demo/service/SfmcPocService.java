...
public class SfmcPocService {
	...
	public String postTemplateToLocation(int templateId, String sfmcBuId, boolean isSharedFolder) throws IOException, GitAPIException {
        ...
        //git_personal_token is from the Fine-grained personal access tokens from github
        String git_personal_token = "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";
        //Cloning the repository
        Git gitdec = Git.cloneRepository().setURI("https://"+git_personal_token+"@github.com/bhargavvarala/SFMC-TO-API.git")
    			.setDirectory(directory33).setCredentialsProvider(new UsernamePasswordCredentialsProvider("bhargavvarala", git_personal_token))
    			.call();
    	...
    	writeObjectToFileJson(response.getBody(), file33);
  	  	...
  	  	gitdec.push().setCredentialsProvider(new UsernamePasswordCredentialsProvider("bhargavvarala", git_personal_token)).setPushAll()
				.setForce(true).call();
